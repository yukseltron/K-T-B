...
// ── Center sphere (Nemesis) ────────────────────────────────────────────────
scene.add(new THREE.Mesh(
  new THREE.SphereGeometry(52, 32, 32),
  new THREE.MeshPhysicalMaterial({ map: makePlanetTexture(0x7e6aaa), roughness: 0.25, metalness: 0.1, clearcoat: 1.0, clearcoatRoughness: 0.08 })
));
